...
export default function EditServiceSeo() {
  const { id } = useParams();

  const navigate = useNavigate();

  const [formData, setFormData] =
    useState<SeoFormType>({
      metaTitle: "",
      metaKeywords: "",
      metaDescription: "",
      mainImageAlt: "",
    ...
    try {
      ...
      if (response.data.success) {
        setFormData({
          ...
          mainImageAlt:
            response.data.data.mainImageAlt || "",
          featuredImageAlt:
            response.data.data.featuredImageAlt || "",
          schemaCode:
      ...
      toast.error(
        error.response?.data?.message ||
          "Something went wrong"
                    ...
                    return (
    <>
      <PageBreadcrumb pageTitle="Service SEO" />

      <div className="space-y-6">
        <ComponentCard title="Service SEO">
