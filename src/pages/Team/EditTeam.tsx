...
import { getCoreTeamByIdApi, updateCoreTeamApi } from "../../api/coreTeamApi";
...
const handleChange = (
  ...
  const handleImage = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!["image/jpeg", "image/webp"].includes(file.type)) {
      setErrors((prev: any) => ({
        ...prev,
        image: "Only .jpg, .jpeg and .webp files are allowed",
      }));
      e.target.value = "";
      return;
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await updateCoreTeamApi(id!, data);
