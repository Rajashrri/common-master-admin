...
export default function GalleryCategory() {
  ...
  const canAdd = hasPermission("gallerycategory", "add");
  const canEdit = hasPermission("gallerycategory", "edit");
  const canDelete = hasPermission("gallerycategory", "delete");
  ...
  return (
    <>
      <PageBreadcrumb pageTitle="Gallery Category" />

      <div className="space-y-6">
        <ComponentCard title="Gallery Category">
          {/* Add Button */}
              ...
              <div className="w-full max-w-lg rounded-xl bg-white shadow-xl">
                ...
                <div className="flex items-center justify-between border-b px-6 py-4">
                  <h3 className="text-lg font-semibold">
                    {isEdit ? "Edit Gallery Category" : "Add Gallery Category"}
                  </h3>
