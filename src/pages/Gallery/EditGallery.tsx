...
export default function EditGallery() {
  ...
  const fetchGallery = async () => {
    const response = await getGalleryDetailApi(id!);
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      const response = await updateGalleryApi(
        id!,
        formData
      );
  ...
  return (
    <>
      <PageBreadcrumb pageTitle="Edit Gallery" />

      <div className="space-y-6">
        <ComponentCard title="Edit Gallery">
                  ...
                  <div>
                    ...
                    {preview && (
                      <img
                        src={preview}
                        alt="Gallery"
                        className="mt-3 h-28 w-36 rounded-lg border object-cover"
                      />
                    )}
                  </div>
